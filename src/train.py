...
def train():
    ...
    print("=" * 80)
    print("\nPhases:")
    print("  1-2000:    Foundation (400x300)   - Learn basics")
    print("  2001-4500: Scaling (640x480)      - Apply skills")  
    print("  4501-6500: Mastery (800x600)      - Handle complexity")
    print("  6501+:     Generalization (mixed) - Adapt to anything")
    print("\n" + "=" * 80)
